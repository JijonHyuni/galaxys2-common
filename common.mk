...
# Rootdir
PRODUCT_COPY_FILES := \
    $(COMMON_PATH)/rootdir/fstab.smdk4210:root/fstab.shw-m250l \
    ...
    $(COMMON_PATH)/rootdir/init.smdk4210.usb.rc:root/init.shw-m250l.usb.rc \
    $(COMMON_PATH)/rootdir/init.smdk4210.rc:root/init.shw-m250l.rc \
    $(COMMON_PATH)/rootdir/ueventd.smdk4210.rc:root/ueventd.shw-m250l.rc

# Recovery rootdir
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/rootdir/init.recovery.smdk4210.rc:root/init.recovery.smdk4210.rc

TARGET_RECOVERY_INITRC := device/samsung/galaxys2-common/rootdir/init.recovery.rc
...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    wifi.supplicant_scan_interval=15 \
		ro.gsm.current.phone-type=2 \
		ro.cdma.home.operator.numeric=45006 \
		ro.cdma.home.operator.alpha=LGT \
